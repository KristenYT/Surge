...
// prettier-ignore
function jxh(e) { const n = e.reduce((e, n) => { const t = e.find((e) => e.name === n.name); if (t) { t.count++; t.items.push({ ...n, name: `${n.name} ${t.count.toString().padStart(2, "0")}${XHFGF}${FNAME}`

, }); } else { e.push({ name: n.name, count: 1, items: [{ ...n, name: `${n.name} 01${XHFGF}${FNAME}`
