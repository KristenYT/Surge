...
// prettier-ignore
function oneP(e) { const t = e.reduce((e, t) => { const n = t.name.replace(/[^A-Za-z0-9\u00C0-\u017F\u4E00-\u9FFF]+\d+$/, ""); if (!e[n]) { e[n] = []; } e[n].push(t); return e; }, {}); for (const e in t) { if (t[e].length === 1 && t[e][0].endsWith("01").name) {/* const n = t[e][0]; n.name = e;*/ t[e][0].name= t[e][0].replace(/[^.]01/.name, "") } } return e; }
// prettier-ignore
