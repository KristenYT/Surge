  ...
  modules: [
    {
      ...
      params: [
        ...
        },
        {
          ...
          enumOptions: [
            { title: "全部泰國劇集", value: "" },
            { title: "Channel 3", value: "network:344" },
            { title: "Channel 7", value: "network:180" },
            { title: "ONE 31", value: "network:1784" },
            { title: "GMM 25", value: "network:1974" },
            { title: "Amarin TV", value: "network:3281" },
            { title: "Workpoint TV", value: "network:2937" },
            { title: "True4U", value: "network:1910" },
            { title: "Thai PBS", value: "network:1018" },
            { title: "Channel 8", value: "network:2978" },
            { title: "GMMTV", value: "company:139247" },
            { title: "GDH 559", value: "company:93758" },
            { title: "GMM Tai Hub (GTH)", value: "company:5369" },
            { title: "Be On Cloud", value: "company:172413" },
            { title: "The One Enterprise", value: "company-name:The One Enterprise" },
            { title: "Nadao Bangkok", value: "company-name:Nadao Bangkok" },
            { title: "Studio Wabi Sabi", value: "company-name:Studio Wabi Sabi" },
            { title: "Mandee Work", value: "company-name:Mandee Work" },
            { title: "Domundi", value: "company-name:Domundi" },
            { title: "Me Mind Y", value: "company-name:Me Mind Y" },
            { title: "IDOLFACTORY", value: "company-name:IDOLFACTORY" },
            { title: "Star Hunter Entertainment", value: "company-name:Star Hunter Entertainment" },
            { title: "Dee Hup House", value: "company-name:Dee Hup House" },
            { title: "CHANGE2561", value: "company-name:CHANGE2561" },
            { title: "Copy A Bangkok", value: "company-name:Copy A Bangkok" },
            { title: "Kantana Group", value: "company-name:Kantana Group" },
            { title: "TV Thunder", value: "company-name:TV Thunder" },
            { title: "Broadcast Thai Television", value: "company-name:Broadcast Thai Television" },
            { title: "Halo Productions", value: "company-name:Halo Productions" },
            { title: "Kongthup Production", value: "company-name:Kongthup Production" },
            { title: "Netflix", value: "provider-name:Netflix" },
            { title: "Disney+", value: "provider-name:Disney Plus|Disney+" },
            { title: "Prime Video", value: "provider-name:Amazon Prime Video|Prime Video" },
            { title: "Apple TV+", value: "provider-name:Apple TV Plus|Apple TV+" },
            { title: "Max / HBO Max", value: "provider-name:Max|HBO Max" },
            { title: "Viu", value: "provider-name:Viu" },
            { title: "iQIYI", value: "provider-name:iQIYI|iQ.com" },
            { title: "WeTV", value: "provider-name:WeTV|Tencent Video" },
            { title: "TrueID", value: "provider-name:TrueID" },
            { title: "AIS PLAY", value: "provider-name:AIS PLAY" },
            { title: "LINE TV", value: "provider-name:LINE TV" },
            { title: "YouTube", value: "provider-name:YouTube|Youtube" }
          ]
        },
        {
          name: "with_genres",
      ...
      params: [
        {
          ...
          enumOptions: [
            ...
            { title: "GMM Tai Hub (GTH)", value: "company:5369" },
            { title: "GMMTV", value: "company:139247" },
            { title: "Sahamongkolfilm", value: "company-name:Sahamongkolfilm" },
            { title: "Five Star Production", value: "company-name:Five Star Production" },
            { title: "M Pictures", value: "company-name:M Pictures" },
            { title: "Transformation Films", value: "company-name:Transformation Films" },
            { title: "CJ Major Entertainment", value: "company-name:CJ Major Entertainment" },
            { title: "Kantana Motion Pictures", value: "company-name:Kantana Motion Pictures" },
            { title: "Mono Film", value: "company-name:Mono Film" },
            { title: "Neramitnung Film", value: "company-name:Neramitnung Film" },
            { title: "185 Films", value: "company-name:185 Films" },
            { title: "Be On Cloud", value: "company:172413" },
            { title: "Netflix", value: "provider-name:Netflix" },
            { title: "Disney+", value: "provider-name:Disney Plus|Disney+" },
            { title: "Prime Video", value: "provider-name:Amazon Prime Video|Prime Video" },
