...
// prettier-ignore
const ZH = ['香港', '澳門', '台灣', '日本', '韓國', '新加坡', '美國', '英國', '法國', '德國', '澳大利亞', '阿聯酋', '阿富汗', '阿爾巴尼亞', '阿爾及利亞', '安哥拉', '阿根廷', '亞美尼亞', '奧地利', '阿塞拜疆', '巴林', '孟加拉', '白俄羅斯', '比利時', '伯利茲', '貝南', '不丹', '玻利維亞', '波斯尼亞和黑塞哥維那', '博茨瓦納', '巴西', '英屬維京群島', '汶萊', '保加利亞', '布基納法索', '布隆迪', '柬埔寨', '喀麥隆', '加拿大', '佛得角', '開曼群島', '中非共和國', '乍得', '智利', '哥倫比亞', '科摩羅', '剛果(布)', '剛果(金)', '哥斯達黎加', '克羅地亞', '塞浦路斯', '捷克', '丹麥', '吉布提', '多明尼加共和國', '厄瓜多', '埃及', '薩爾瓦多', '赤道幾內亞', '厄立特里亞', '愛沙尼亞', '埃塞俄比亞', '斐濟', '芬蘭', '加蓬', '甘比亞', '格魯吉亞', '迦納', '希臘', '格陵蘭', '危地馬拉', '幾內亞', '圭亞那', '海地', '宏都拉斯', '匈牙利', '冰島', '印度', '印尼', '伊朗', '伊拉克', '愛爾蘭', '馬恩島', '以色列', '義大利', '象牙海岸', '牙買加', '約旦', '哈薩克', '肯亞', '科威特', '吉爾吉斯', '寮國', '拉脫維亞', '黎巴嫩', '賴索托', '賴比瑞亞', '利比亞', '立陶宛', '盧森堡', '北馬其頓', '馬達加斯加', '馬拉威', '馬來西亞', '馬爾地夫', '馬利', '馬爾他', '茅利塔尼亞', '模里西斯', '墨西哥', '摩爾多瓦', '摩納哥', '蒙古', '蒙特內哥羅', '摩洛哥', '莫三比克', '緬甸', '納米比亞', '尼泊爾', '荷蘭', '紐西蘭', '尼加拉瓜', '尼日', '奈及利亞', '北韓', '挪威', '阿曼', '巴基斯坦', '巴拿馬', '巴拉圭', '秘魯', '菲律賓', '葡萄牙', '波多黎各', '卡達', '羅馬尼亞', '俄羅斯', '盧安達', '聖馬利諾', '沙烏地阿拉伯', '塞內加爾', '塞爾維亞', '獅子山', '斯洛伐克', '斯洛維尼亞', '索馬利亞', '南非', '西班牙', '斯里蘭卡', '蘇丹', '蘇利南', '史瓦帝尼', '瑞典', '瑞士', '敘利亞', '塔吉克', '坦尚尼亞', '泰國', '多哥', '東加', '千里達及托巴哥', '突尼西亞', '土耳其', '土庫曼', '美屬維京群島', '烏干達', '烏克蘭', '烏拉圭', '烏茲別克', '委內瑞拉', '越南', '葉門', '尚比亞', '辛巴威', '安道爾', '留尼旺', '波蘭', '關島', '梵蒂岡', '列支敦斯登', '庫拉索', '塞席爾', '南極', '直布羅陀', '古巴', '法羅群島', '奧蘭群島', '百慕達', '東帝汶'];
// prettier-ignore
...
const rurekey = {
  ...
  美國: /(深|沪|呼|京|广|杭)美|波特兰|芝加哥|哥伦布|纽约|硅谷|俄勒冈|西雅图|芝加哥/g,
  波斯尼亚和黑塞哥维那: /波黑共和国/g,
  印尼: /印度尼西亚|雅加达/g,
  印度: /孟买/g,
  阿联酋: /迪拜|阿拉伯联合酋长国/g,
